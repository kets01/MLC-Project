...
void Norm::emit_rms_v7() {
    ...
    ops.push_back( I::base_mov_reg_x( I::x19, I::x0 ) );
    ops.push_back( I::base_mov_reg_x( I::x20, I::x1 ) );
    ops.push_back( I::base_mov_reg_x( I::x21, I::x2 ) );
    ops.push_back( I::base_mov_reg_x( I::x22, I::x3 ) );
    ops.push_back( I::base_mov_reg_x( I::x23, I::x4 ) );
    ops.push_back( I::base_lsl_x( I::x24, I::x5, 2 ) );
    ops.push_back( I::base_lsl_x( I::x25, I::x6, 2 ) );
    ops.push_back( I::simd_str_imm_s( I::v0, I::sp, 120 ) );   // eps stash

    size_t fix_cbz = ops.size();
    ops.push_back( 0 );                                        // cbz m, row_done
    ...
    ops.push_back( I::fp_fmov_imm_s( I::v0, 0x70 ) );          // s0 = 1.0
    ops.push_back( I::fp_scvtf_s_x( I::v1, I::x23 ) );
    ops.push_back( I::fp_fdiv_s( I::v0, I::v0, I::v1 ) );
    ops.push_back( I::sve_dup_elem_s( I::z17, I::z0, 0 ) );    // z17 = {1/N,...}
    ...
    size_t red_col = ops.size();
    ops.push_back( I::sme2_ld1w_x4( I::z0, I::p8, I::x8 ) );   // 4 blocks, 1 insn
    ops.push_back( I::sve_fmla_s( I::z4, I::p0, I::z0, I::z0 ) );
    ops.push_back( I::sve_fmla_s( I::z5, I::p0, I::z1, I::z1 ) );
    ops.push_back( I::sve_fmla_s( I::z6, I::p0, I::z2, I::z2 ) );
    ops.push_back( I::sve_fmla_s( I::z7, I::p0, I::z3, I::z3 ) );
    ops.push_back( I::base_add_reg_x( I::x8, I::x8, I::x24 ) );
    ops.push_back( I::base_subs_imm_x( I::x9, I::x9, 1 ) );
    ops.push_back( I::base_b_ne( back( ops, red_col ) ) );

    for ( int i = 0; i < 4; ++i )
        ops.push_back( I::sve_fmul_p_s( acc[i], I::p0, I::z17 ) );
    for ( int i = 0; i < 4; ++i )
        ops.push_back( I::sve_fadd_p_s( acc[i], I::p0, I::z8 ) );

    const I::sve_t inv[4] = { I::z20, I::z21, I::z22, I::z23 };
    for ( int i = 0; i < 4; ++i ) {
        ops.push_back( I::sve_frsqrte_s( inv[i], acc[i] ) );
        ops.push_back( I::sve_fmul_s( I::z18, inv[i], acc[i] ) );
        ops.push_back( I::sve_frsqrts_s( I::z18, inv[i], I::z18 ) );
        ops.push_back( I::sve_fmul_s( inv[i], inv[i], I::z18 ) );
    }
    ...
    ops.push_back( I::sme2_ld1w_x4( I::z0, I::p8, I::x8 ) );
    for ( int i = 0; i < 4; ++i )
        ops.push_back( I::sve_fmul_p_s( (I::sve_t)(I::z0 + i), I::p0, I::z16 ) );
    for ( int i = 0; i < 4; ++i )
        ops.push_back( I::sve_fmul_p_s( (I::sve_t)(I::z0 + i), I::p0, inv[i] ) );
    ops.push_back( I::sme2_st1w_x4( I::z0, I::p8, I::x9 ) );
    ops.push_back( I::base_add_reg_x( I::x8, I::x8, I::x24 ) );
    ops.push_back( I::base_add_reg_x( I::x9, I::x9, I::x25 ) );
    ops.push_back( I::base_add_imm_x( I::x10, I::x10, 4 ) );
    ops.push_back( I::base_subs_imm_x( I::x11, I::x11, 1 ) );
...
void Norm::emit_layer_v7() {
    ...
    ops.push_back( I::base_mov_reg_x( I::x22, I::x3 ) );
    ops.push_back( I::base_mov_reg_x( I::x23, I::x4 ) );
    ops.push_back( I::base_mov_reg_x( I::x24, I::x5 ) );
    ops.push_back( I::base_lsl_x( I::x25, I::x6, 2 ) );
    ops.push_back( I::base_lsl_x( I::x26, I::x7, 2 ) );
    ops.push_back( I::simd_str_imm_s( I::v0, I::sp, 128 ) );

    size_t fix_cbz = ops.size();
    ops.push_back( 0 );                                     // cbz m, ret
    ...
    ops.push_back( I::fp_fmov_imm_s( I::v0, 0x70 ) );
    ops.push_back( I::fp_scvtf_s_x( I::v1, I::x24 ) );
    ops.push_back( I::fp_fdiv_s( I::v0, I::v0, I::v1 ) );
    ops.push_back( I::sve_dup_elem_s( I::z4, I::z0, 0 ) );  // z4 = {1/N,...}
    ...
    for ( int i = 0; i < 4; ++i ) ops.push_back( I::sve_dup_imm_s( mean[i], 0 ) );
    ops.push_back( I::base_mov_reg_x( I::x8, I::x19 ) );
    ops.push_back( I::base_mov_reg_x( I::x9, I::x24 ) );
    ...
    ops.push_back( I::sme2_ld1w_x4( I::z0, I::p8, I::x8 ) );
    for ( int i = 0; i < 4; ++i )
        ops.push_back( I::sve_fadd_p_s( mean[i], I::p0, (I::sve_t)(I::z0 + i) ) );
    ops.push_back( I::base_add_reg_x( I::x8, I::x8, I::x25 ) );
    ops.push_back( I::base_subs_imm_x( I::x9, I::x9, 1 ) );
    ops.push_back( I::base_b_ne( back( ops, gp1col ) ) );

    for ( int i = 0; i < 4; ++i )
        ops.push_back( I::sve_fmul_p_s( mean[i], I::p0, I::z4 ) );

    // pass 2: centered variance
    const I::sve_t var[4] = { I::z12, I::z13, I::z14, I::z15 };
    for ( int i = 0; i < 4; ++i ) ops.push_back( I::sve_dup_imm_s( var[i], 0 ) );
    ops.push_back( I::base_mov_reg_x( I::x8, I::x19 ) );
    ops.push_back( I::base_mov_reg_x( I::x9, I::x24 ) );
    ...
    ops.push_back( I::sme2_ld1w_x4( I::z0, I::p8, I::x8 ) );
    for ( int i = 0; i < 4; ++i )
        ops.push_back( I::sve_fsub_p_s( (I::sve_t)(I::z0 + i), I::p0, mean[i] ) );
    for ( int i = 0; i < 4; ++i )
        ops.push_back( I::sve_fmla_s( var[i], I::p0,
                                      (I::sve_t)(I::z0 + i), (I::sve_t)(I::z0 + i) ) );
    ops.push_back( I::base_add_reg_x( I::x8, I::x8, I::x25 ) );
    ops.push_back( I::base_subs_imm_x( I::x9, I::x9, 1 ) );
    ops.push_back( I::base_b_ne( back( ops, gp2col ) ) );
    ...
    size_t gp3col = ops.size();
    ops.push_back( I::sme2_ld1w_x4( I::z0, I::p8, I::x8 ) );
    ops.push_back( I::sve_ld1rw_s( I::z5, I::p0, I::x10 ) );
    ops.push_back( I::sve_ld1rw_s( I::z6, I::p0, I::x11 ) );
    for ( int i = 0; i < 4; ++i )
        ops.push_back( I::sve_fsub_p_s( (I::sve_t)(I::z0 + i), I::p0, mean[i] ) );
    for ( int i = 0; i < 4; ++i )
        ops.push_back( I::sve_fmul_p_s( (I::sve_t)(I::z0 + i), I::p0, isd[i] ) );
    for ( int i = 0; i < 4; ++i )
        ops.push_back( I::sve_fmul_p_s( (I::sve_t)(I::z0 + i), I::p0, I::z5 ) );
    for ( int i = 0; i < 4; ++i )
        ops.push_back( I::sve_fadd_p_s( (I::sve_t)(I::z0 + i), I::p0, I::z6 ) );
    ops.push_back( I::sme2_st1w_x4( I::z0, I::p8, I::x9 ) );
    ops.push_back( I::base_add_reg_x( I::x8, I::x8, I::x25 ) );
    ops.push_back( I::base_add_reg_x( I::x9, I::x9, I::x26 ) );
    ops.push_back( I::base_add_imm_x( I::x10, I::x10, 4 ) );
...
Norm::error_t Norm::generate( ntype_t ntype, isa_t isa ) {
    m_ops.clear();
    m_ntype = ntype;
    ...
    if ( isa == isa_t::sme2 ) {
        if ( ntype == ntype_t::rms ) emit_rms_v7();
        else                         emit_layer_v7();
    } else {
